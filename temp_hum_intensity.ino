...
String apiKey = "3VSQFUU3JRXLS382";    // Edit this API key according to your Account

String Host_Name = "pialy";         // Edit Host_Name

String Password = "0123456789";          // Edit Password
...
void loop() {
  ...
  int ldrStatus = analogRead(ldrPin);              // reading intensity value
  ...
  String state3=String(ldrStatus); 
...
String getStr = "GET /update?api_key=";         // prepare GET string
  ...
  getStr += String(state3);                       // intensity data
